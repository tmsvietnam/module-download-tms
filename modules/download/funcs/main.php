            ...
            if ($num_items) {
                ...
                while ($row = $result->fetch()) {
                    ...
                    $array_item[$row['id']] = array(
                        ...
                        'more_link' => nv_url_rewrite(NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $row['alias'], true),
                ...
                $array_cats[$value['id']]['link'] = nv_url_rewrite(NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $value['alias'], true);
